...
var EditPageMixin = {
	...
	var Table1ListComponent = Vue.component('table1List', {
		template: '#table1List',
	...
	var Table1ViewComponent = Vue.component('table1View', {
		template : '#table1View',
	...
	var Table1AddComponent = Vue.component('table1Add', {
		template : '#table1Add',
		mixins: [AddPageMixin],
		props:{
			pagename : {
	...
	var Table1EditComponent = Vue.component('table1Edit', {
		template : '#table1Edit',
